...
function mobileMenu() {
  if (document.getElementById('menu__button')) {
    ...
    var _mobileMenu = document.querySelector('.header__inner-wrap');
    var mobileMenuItems = document.querySelectorAll('nav ul li');
    ...
    hamburger.addEventListener('click', function () {
      ...
      _mobileMenu.classList.toggle('header__inner-wrap--active');
    ...
    window.addEventListener('resize', function () {
      ...
      if (screenWidth >= 1200) {
        ...
        _mobileMenu.classList.remove('header__inner-wrap--active');
